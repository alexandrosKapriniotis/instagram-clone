...
import { container, form, navbar, text, utils } from '../components/styles';
...
function EditScreen(props) {
    ...
    const [image, setImage] = useState(props.currentUser.profile_picture);
...
export default connect(mapStateToProps, mapDispatchProps)(EditScreen);